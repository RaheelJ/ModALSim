...
z1=E_fr+0.25*E_ac+E_wh+E_dw+E_esd+E_pp+E_st+E_l+E_th+E_w+E_d;
...
z2=(4*C_ac+C_fr)+(C_wh+C_dw+C_pp+C_st+C_w+C_d)+C_th+C_l+C_esd;
...
z3=(G_fr+4*G_ac+G_wh+G_gh+G_dw+G_esd+G_pp+G_st+G_th+G_w)+G_d+G_l;
...
z4=sum((T_in-Tset_in).^2)+sum((T_fr-Tset_fr).^2)+sum((T_wh-Tset_wh).^2);
